...
## iTerm Profile
This basically gives you traditional key bindings like alt+b to navigate back a word etc.
```
{
  "Custom Directory" : "No",
  "Tags" : [
  ...
  "Guid" : "B8E329E2-282C-4A03-BD04-1681B5BC699D",
  "Ansi 1 Color" : {
